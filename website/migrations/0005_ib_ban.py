...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IPBan'
        db.create_table('website_ipban', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
        ))
        db.send_create_signal('website', ['IPBan'])


    def backwards(self, orm):
        # Deleting model 'IPBan'
        db.delete_table('website_ipban')
