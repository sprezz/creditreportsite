...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'IPBan', fields ['ip']
        db.create_unique('website_ipban', ['ip'])


    def backwards(self, orm):
        # Removing unique constraint on 'IPBan', fields ['ip']
        db.delete_unique('website_ipban', ['ip'])
