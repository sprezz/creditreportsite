...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visitor.organization'
        db.add_column('website_visitor', 'organization',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visitor.isp'
        db.add_column('website_visitor', 'isp',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visitor.organization'
        db.delete_column('website_visitor', 'organization')

        # Deleting field 'Visitor.isp'
        db.delete_column('website_visitor', 'isp')
