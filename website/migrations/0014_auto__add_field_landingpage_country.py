...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LandingPage.country'
        db.add_column('website_landingpage', 'country',
                      self.gf('django.db.models.fields.CharField')(default='US', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LandingPage.country'
        db.delete_column('website_landingpage', 'country')
