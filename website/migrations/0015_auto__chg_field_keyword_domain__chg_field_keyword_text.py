...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Keyword.domain'
        db.alter_column('website_keyword', 'domain', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Keyword.text'
        db.alter_column('website_keyword', 'text', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Keyword.domain'
        db.alter_column('website_keyword', 'domain', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Keyword.text'
        db.alter_column('website_keyword', 'text', self.gf('django.db.models.fields.CharField')(max_length=20))
